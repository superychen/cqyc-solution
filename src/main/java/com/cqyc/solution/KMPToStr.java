...
public class KMPToStr {
    ...
    public int[] buildNext(String needle, int[] res) {
        res[0] = -1;
        int i = 0;
        int j = -1;
    ...
    public static void main(String[] args) {
        String str = "butsadsad";
        String str1 = "sad";
        KMPToStr kmpToStr = new KMPToStr();
//        System.out.println(kmpToStr.strStr(str, str1));

        String a = "ABCABXYABCABATDM";
        kmpToStr.buildNext(a, new int[a.length()]);
    }
